...
func main() {
	...
	// Treeview columns
	tv.Column("#0", Anchor("w"), Width(120), Stretch(false), Separator(true))
	tv.Column(1, Anchor("w"), Width(120), Stretch(true), Separator(true))
	tv.Column(2, Anchor("w"), Width(120), Stretch(false), Separator(true))
